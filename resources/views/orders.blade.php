    ...
    <div class="flex flex-col items-center justify-center">
        ...
        <div class="flex flex-col items-center py-5 px-8 gap-6 w-full  border border-black/10 rounded-[20px]">
            <div class="flex justify-between w-full">
                <div>
                    <h2 class="font-satoshi font-bold text-[16px] lg:text-[20px]">Order #67691230</h2>
                    <span class="font-satoshim text-[16px] text-black/60">August 16, 2023 &nbsp; • &nbsp; 3 items</span>
                </div>
            ...
            <div class="flex flex-row w-full">
                <div class="flex flex-row gap-4 border-r-3 border-black/10 pr-20 w-full max-w-[40%]">
                    <div>
                ...
                <div class="flex justify-between w-full max-w-[60%] pl-20">
                    <div class="flex flex-col gap-2">
                        <span class="font-satoshi font-bold text-[24px]">$259.96</span>
