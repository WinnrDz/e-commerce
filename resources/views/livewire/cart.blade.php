        ...
        @if ($cart->variants->isEmpty())
            <div class="flex flex-col w-full items-center">
                ...
                <div class="flex flex-row justify-center gap-10  w-full">
                        ...
                        @if (session('success'))
                            <a href="{{ route('account.order', $order_id) }}" class="flex items-center justify-center gap-3 bg-black text-white font-satoshim text-[16px] w-full max-w-[300px] py-4  rounded-[62px] cursor-pointer">
            ...
            <div class="flex flex-col py-5 px-6 gap-6 w-full max-w-126.25 border border-black/10 rounded-[20px]">
                ...
                <div class="flex flex-col gap-5">
                    <div class="flex justify-between">
                        ...
                        <span class="font-satoshi font-bold text-[16px] lg:text-[20px]">${{ $cart->subtotal() }}</span>
                    </div>
                    <div class="flex justify-between">
                    ...
                    <div class="flex justify-between">
                        ...
                        <span class="font-satoshi font-bold text-[16px] lg:text-[20px]">$0</span>
                    </div>
                    <div class="w-full h-px bg-black opacity-10"></div>
                    <div class="flex justify-between">
                        <span class="font-satoshi text-[16px] lg:text-[20px]">Total</span>
                        <span class="font-satoshi font-bold text-[24px]">${{ $cart->subtotal() }}</span>
                    </div>
                </div>
