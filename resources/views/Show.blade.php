    ...
    <div class="flex flex-col items-center justify-center">
        ...
        <div class="flex flex-col w-320 mt-15 gap-8">
            ...
            <div class="flex flex-wrap gap-8">
                <div
                    class="border border-black/10 rounded-[20px] w-152 h-60 p-6 flex flex-col justify-around">
                    <div class="flex justify-between">
                         <div class="flex gap-2">
            ...
            <div class="flex justify-center"><button class="font-satoshim text-[16px] rounded-[62px] w-57 h-13 border border-black/10">Load More Reviews</button></div>
        </div>
    </div>
@endsection
